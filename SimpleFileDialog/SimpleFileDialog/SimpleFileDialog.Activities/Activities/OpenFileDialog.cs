...
{
    [LocalizedDisplayName(nameof(Resources.OpenFileDialog_DisplayName))]
    [LocalizedDescription(nameof(Resources.OpenFileDialog_Description))]
    public class OpenFileDialog : ContinuableAsyncCodeActivity
    {
        #region Properties
        ...
        [LocalizedDisplayName(nameof(Resources.OpenFileDialog_Title_DisplayName))]
        [LocalizedDescription(nameof(Resources.OpenFileDialog_Title_Description))]
        [LocalizedCategory(nameof(Resources.Input_Category))]
        public InArgument<string> Title { get; set; }

        [LocalizedDisplayName(nameof(Resources.OpenFileDialog_InitialPath_DisplayName))]
        [LocalizedDescription(nameof(Resources.OpenFileDialog_InitialPath_Description))]
        [LocalizedCategory(nameof(Resources.Input_Category))]
        public InArgument<string> InitialPath { get; set; }

        [LocalizedDisplayName(nameof(Resources.OpenFileDialog_FileType_DisplayName))]
        [LocalizedDescription(nameof(Resources.OpenFileDialog_FileType_Description))]
        [LocalizedCategory(nameof(Resources.Options_Category))]
        public FileTypes FileType { get; set; } = 0;

        [LocalizedDisplayName(nameof(Resources.OpenFileDialog_SelectedFilePath_DisplayName))]
        [LocalizedDescription(nameof(Resources.OpenFileDialog_SelectedFilePath_Description))]
